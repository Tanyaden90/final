      ...
      return Scaffold(
        ...
        body: Container(
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                const SizedBox(width: 280, height: 180, child: Image(image: AssetImage('assets/52619-79-article-image.jpg')),),
            ...
            child: Form(
              ...
              child: Column(
                children: [
                  ...
                  const SizedBox(width: 90, height: 90, child: Image(image: AssetImage('assets/busts-in-silhouette-facebook.png')),),
